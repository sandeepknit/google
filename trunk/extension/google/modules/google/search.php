...
include_once( eZExtension::baseDirectory() .'/google/classes/google.php' );
/*!
 Get search limit
 */
...
if ( $useSearchCode )
{
    $searchResult = Google::search( $searchText, array( 'SearchSectionID' => $searchSectionID,
...
if ( trim( $ViewMode ) != '' )
{
    ...
    $Result['content'] =& $tpl->fetch( "design:google/search/$ViewMode.tpl" );
}
else
{
    $Result['content'] =& $tpl->fetch( 'design:google/search.tpl' );
}
